          ...
          <div style={{ display:"flex", gap:18, marginBottom:22, alignItems:"flex-start" }}>
            ...
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <div style={{ marginTop:14, display:"flex", gap:10, flexWrap:"wrap" }}>
                <button style={{ background:"#2ecc7122", border:"1px solid #2ecc7144", color:"#2ecc71", borderRadius:4, padding:"9px 18px", cursor:"pointer", fontSize:14, fontFamily:"monospace" }} onClick={()=>washNow(selected.id)}>💧 Lavei agora</button>
